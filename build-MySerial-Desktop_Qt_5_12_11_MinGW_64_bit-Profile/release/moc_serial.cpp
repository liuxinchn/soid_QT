...
#include "../../../../HandleGas/SCQT_QT_v2/QtAppProject-mySerial/serial.h"
...
QT_MOC_LITERAL(1, 7, 10), // "readSignal"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "readData"
QT_MOC_LITERAL(4, 28, 9) // "com_delay"

    },
    "Serial\0readSignal\0\0readData\0com_delay"
};
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::readSignal)) {
                *result = 0;
                return;
            }
        }
